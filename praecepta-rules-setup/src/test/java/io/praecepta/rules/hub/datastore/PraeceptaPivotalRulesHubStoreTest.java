...
public class PraeceptaPivotalRulesHubStoreTest {
	...
	private Map<PraeceptaRuleSpaceCompositeKey, Map<String, Collection<PraeceptaRuleSideCars>>> ruleSideCarData;
	...
	public void testGetAllActiveObjects() {
		...
		Collection<PraeceptaRuleSideCars> sideCars = hubStore.getAllActiveRuleSideCars();
	...
	public void testActiveSpacesWithRuleSideCarsForAVerison() {
		...
		Collection<PraeceptaRuleSideCars> sideCarsForARuleSpace = hubStore.getActiveSidecarsForARuleSpaces(compositeKey, "2V2");
		
		assertNotNull(sideCarsForARuleSpace);
		
		assertTrue(sideCarsForARuleSpace.size() > 0 ? true : false);
		
		Collection<PraeceptaRuleSideCars> sideCarsForARuleSpace1 = hubStore.getActiveSidecarsForARuleSpaces(compositeKey, "DummyVersion");
	...
	public void testActiveSpacesWithRuleSideCarsForAVerisonAndGroupName() {
		...
		PraeceptaRuleSideCars sideCarsForARuleSpaceAndGrpName = hubStore.getSideCarsForSpaceAndVersionAndGroupName(compositeKey, "2V2", "21RuleGroupName");
		
		assertNotNull(sideCarsForARuleSpaceAndGrpName);
		
		PraeceptaRuleSideCars sideCarsForARuleSpaceAndGrpName1 = hubStore.getSideCarsForSpaceAndVersionAndGroupName(compositeKey, "2V2", "DummyVersion");
	...
	private void buildInput() {
		...
		Map<String, Collection<PraeceptaRuleSideCars>> versionToSideCarsMapForCompositeKey1 = new HashMap<>();
		...
		Map<String, Collection<PraeceptaRuleSideCars>> versionToSideCarsMapForCompositeKey2 = new HashMap<>();
		...
		Map<String, Collection<PraeceptaRuleSideCars>> versionToSideCarsMapForCompositeKey3 = new HashMap<>();
	...
	private PraeceptaRuleSideCars buildSideCarwithGrpName(PraeceptaRuleSpaceCompositeKey compositeKey1, String grpName) {
		return new PraeceptaRuleSideCars(compositeKey1) {

			@Override
			public PraeceptaRuleGroupSideCars getRuleGroupSideCars() {
				return new PraeceptaRuleGroupSideCars() {
