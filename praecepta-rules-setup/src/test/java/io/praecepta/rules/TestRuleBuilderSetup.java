...
//		
		...
		PraeceptaRuleSpaceCompositeKey keyToUpdate=objRuleSpace.getRuleSpaceKey();
		...
		PraeceptaRuleSpaceCompositeKey keyToDelete = new PraeceptaRuleSpaceCompositeKey("test1", "005", "ACATS");
		keyToDelete.setVersion("");
		hubManager.deleteRuleSpace(keyToDelete, "V1");
	...
	public void testRuleSideCarsSetup() {
		...
		PraeceptaRuleSideCars ruleSideCars=new PraeceptaRuleSideCars("test1", "CLNT1", "praecepta");
		...
		List<PraeceptaRuleSideCars> ruleSideCarsFrmDB=hubManager.fetchRuleSideCars(key, key.getVersion());
		
		Assert.assertNotNull(ruleSideCarsFrmDB);
		
	}
	
	private PraeceptaRuleGroupSideCars getRuleGroupSideCars(String ruleGroupName) {
		PraeceptaRuleGroupSideCars ruleGrpSidecras=new PraeceptaRuleGroupSideCars();
		...
		PraeceptaRuleLevelSideCars ruleLevelSideCars=new PraeceptaRuleLevelSideCars();
