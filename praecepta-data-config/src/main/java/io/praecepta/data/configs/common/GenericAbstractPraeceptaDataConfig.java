...
public abstract class GenericAbstractPraeceptaDataConfig implements IPraeceptaDataConfig {
...
//		return ImmutableMap.copyOf(predefinedElementNameToDataTypeMap);
		return Collections.unmodifiableMap(predefinedElementNameToDataTypeMap);
	}
	...
	public Map<String, String> getDataConfigurationWithValues() {
