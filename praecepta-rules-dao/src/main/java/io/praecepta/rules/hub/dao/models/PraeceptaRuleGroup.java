...
public class PraeceptaRuleGroup implements IModel{
	...
	private Collection<IPraeceptaAction<PraeceptaRequestStore>> actionToPerform;

	private Collection<IPraeceptaAction<PraeceptaRequestStore>> actionToPerformOnFailure;
	...
	public Collection<IPraeceptaAction<PraeceptaRequestStore>> getActionToPerform() {
		return actionToPerform;
	}
	public void setActionToPerform(Collection<IPraeceptaAction<PraeceptaRequestStore>> actionToPerform) {
		this.actionToPerform = actionToPerform;
	}
	public Collection<IPraeceptaAction<PraeceptaRequestStore>> getActionToPerformOnFailure() {
		return actionToPerformOnFailure;
	}
	public void setActionToPerformOnFailure(
			Collection<IPraeceptaAction<PraeceptaRequestStore>> actionToPerformOnFailure) {
