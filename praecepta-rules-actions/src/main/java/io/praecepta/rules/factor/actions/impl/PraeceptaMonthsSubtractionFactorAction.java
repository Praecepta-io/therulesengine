...
public class PraeceptaMonthsSubtractionFactorAction extends PraeceptaDateFactorAction {

	private static final Logger LOG = LoggerFactory.getLogger(PraeceptaMonthsSubtractionFactorAction.class);
	...
	public PraeceptaActionHolder performAction(Object value, Map<PraeceptaActionParametersType,Object> parameters) {
		...
		if (validateDataType(value, factorValue)) {
			...
			if (date != null) {
				...
				c.setTime(date);
				c.add(Calendar.MONTH, Integer.valueOf(factorValue.toString()) * -1);
