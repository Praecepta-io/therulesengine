...
public class PraeceptaDaysAdditionFactorAction extends PraeceptaDateFactorAction{

	private static final Logger LOG = LoggerFactory.getLogger(PraeceptaDaysAdditionFactorAction.class); 
	...
	public PraeceptaActionHolder performAction(Object value, Map<PraeceptaActionParametersType,Object> parameters) {
		...
		if (validateDataType(value, factorValue)) {
			...
			if (date != null) {
				...
				c.setTime(date);
				c.add(Calendar.DATE, Integer.valueOf(factorValue.toString()));
