...
public abstract class AbstractPraeceptaElasticLifeCycleDao<KEY extends Serializable, ENTITY extends IPraeceptaEsEntityModel<KEY>>
		extends AbstractPraeceptaElasticDao<KEY, ENTITY> implements IndexOperations {

	private IndexOperations esIndexOperations;

	public AbstractPraeceptaElasticLifeCycleDao(ElasticsearchOperations esOperations) {
		super(esOperations);
