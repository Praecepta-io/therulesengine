...
public class PraeceptaGreaterthanNumberConditionalEvaluatorTest {

	@Test
	public void testPositive() {

		PraeceptaSimpleCondition condition = new PraeceptaSimpleCondition("attr1", ConditionOperatorType.GREATER_THAN_NUMBER, new ConditionValueHolder<Number>(1000,100));
		
		IPraeceptaConditionalEvaluator<PraeceptaSimpleCondition> strNotEmptyEval = new PraeceptaNumberGreaterThanConditionalEvaluator<>();
	...
	public void testNegativeWithSameValues() {
		...
		PraeceptaSimpleCondition condition = new PraeceptaSimpleCondition("attr1", ConditionOperatorType.GREATER_THAN_NUMBER, new ConditionValueHolder<Number>(100, 100));
	...
	public void testNegativeWithDifferentValues() {
		...
		PraeceptaSimpleCondition condition = new PraeceptaSimpleCondition("attr1", ConditionOperatorType.GREATER_THAN_NUMBER, new ConditionValueHolder<Number>(99, 100));
	...
	public void testNegativeWithWrongDataType() {
		...
		PraeceptaSimpleCondition condition = new PraeceptaSimpleCondition("attr1", ConditionOperatorType.GREATER_THAN_NUMBER, new ConditionValueHolder<String>("10", "20"));
