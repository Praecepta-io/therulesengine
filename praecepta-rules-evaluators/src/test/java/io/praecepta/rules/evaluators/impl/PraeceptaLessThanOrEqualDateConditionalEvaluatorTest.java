...
public class PraeceptaLessThanOrEqualDateConditionalEvaluatorTest {
	...
	public void testPositive() {
		...
		PraeceptaSimpleCondition condition = new PraeceptaSimpleCondition("attr1", ConditionOperatorType.LESS_THAN_EQUAL_DATE, new ConditionValueHolder<String>("2022-10-10","2022-10-10"), metaData);
	...
	public void testPositive_DateWithTime() {
		...
		PraeceptaSimpleCondition condition = new PraeceptaSimpleCondition("attr1", ConditionOperatorType.LESS_THAN_DATE, new ConditionValueHolder<String>("2022-10-10 10:10:11","2022-10-10 10:10:12"), metaData);
		
		IPraeceptaConditionalEvaluator<PraeceptaSimpleCondition> strNotEmptyEval = new PraeceptaDateLessThanConditionalEvaluator<>();
	...
	public void testPositive_WIthDifferent_Formats() {
		...
		metaData.put("fromDateFormat", "yyyy/mm/dd");
		metaData.put("toDateFormat", "yyyy-mm-dd");
		PraeceptaSimpleCondition condition = new PraeceptaSimpleCondition("attr1", ConditionOperatorType.LESS_THAN_DATE, new ConditionValueHolder<String>("2022/10/11","2022-10-12"), metaData);
	...
	public void testNegativeWithDifferentValues() {
		...
		metaData.put("fromDateFormat", "yyyy-MM-dd");
		metaData.put("toDateFormat", "yyyy-MM-dd");
		PraeceptaSimpleCondition condition = new PraeceptaSimpleCondition("attr1", ConditionOperatorType.LESS_THAN_DATE, new ConditionValueHolder<String>("2022-10-10","2022-10-09"), metaData);
	...
	public void testNegativeWithWrongDataType() {
		...
		PraeceptaSimpleCondition condition = new PraeceptaSimpleCondition("attr1", ConditionOperatorType.LESS_THAN_DATE, new ConditionValueHolder<Number>(10, 20));
