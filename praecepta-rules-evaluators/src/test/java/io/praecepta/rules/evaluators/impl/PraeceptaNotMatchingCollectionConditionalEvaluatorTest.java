...
public class PraeceptaNotMatchingCollectionConditionalEvaluatorTest {

	@Test
	public void testPositive() {

		PraeceptaSimpleCondition condition = new PraeceptaSimpleCondition("attr1", ConditionOperatorType.NOT_MATCHING_COLLECTION, new ConditionValueHolder<String>("Test!#@#Test5!#@#Test4","Test3!#@#Test!#@#Test4"));
		
		IPraeceptaConditionalEvaluator<PraeceptaSimpleCondition> strNotEmptyEval = new PraeceptaNotMatchingCollectionConditionalEvaluator<>();
	...
	public void testNegativeWithDifferentValues() {
		...
		PraeceptaSimpleCondition condition = new PraeceptaSimpleCondition("attr1", ConditionOperatorType.NOT_MATCHING_COLLECTION, new ConditionValueHolder<String>("Test!#@#Test3!#@#Test4","Test3!#@#Test!#@#Test4"));
	...
	public void testNegativeWithWrongDataType() {
		...
		PraeceptaSimpleCondition condition = new PraeceptaSimpleCondition("attr1", ConditionOperatorType.NOT_MATCHING_COLLECTION, new ConditionValueHolder<Integer>(10, 20));
