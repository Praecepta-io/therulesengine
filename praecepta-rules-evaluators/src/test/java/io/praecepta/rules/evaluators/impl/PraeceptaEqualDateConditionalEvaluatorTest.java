...
public class PraeceptaEqualDateConditionalEvaluatorTest {
	...
	public void testPositive() {
		...
		PraeceptaSimpleCondition condition = new PraeceptaSimpleCondition("attr1", ConditionOperatorType.EQUAL_DATE, new ConditionValueHolder<String>("2022-10-10","2022-10-10"), metaData);
		
		IPraeceptaConditionalEvaluator<PraeceptaSimpleCondition> strNotEmptyEval = new PraeceptaDateEqualConditionalEvaluator<>();
	...
	public void testPositive_DateWithTime() {
		...
		PraeceptaSimpleCondition condition = new PraeceptaSimpleCondition("attr1", ConditionOperatorType.EQUAL_DATE, new ConditionValueHolder<String>("2022-10-10 10:10:10","2022-10-10 10:10:10"), metaData);
	...
	public void testNegativeWithDifferentValues() {
		...
		metaData.put("fromDateFormat", "yyyy-MM-dd");
		metaData.put("toDateFormat", "yyyy-MM-dd");
		PraeceptaSimpleCondition condition = new PraeceptaSimpleCondition("attr1", ConditionOperatorType.EQUAL_DATE, new ConditionValueHolder<String>("2022-10-10","2022-10-11"), metaData);
	...
	public void testNegativeWithWrongDataType() {
		...
		PraeceptaSimpleCondition condition = new PraeceptaSimpleCondition("attr1", ConditionOperatorType.EQUAL_DATE, new ConditionValueHolder<Number>(10, 20));
