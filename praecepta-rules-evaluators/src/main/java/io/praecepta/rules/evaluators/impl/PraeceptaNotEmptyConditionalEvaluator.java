...
public final class PraeceptaNotEmptyConditionalEvaluator<INPUT extends PraeceptaSimpleCondition> extends PraeceptaAbstractConditionalEvaluator<INPUT> {
	...
	protected boolean validateConditionOperatorType(ConditionOperatorType operatorTypeFromInput) {
		return  ConditionOperatorType.NOT_EMPTY == operatorTypeFromInput ? true : false ;
	}
