...
public class PraeceptaDateGreaterThanEqualConditionalEvaluator<INPUT extends PraeceptaSimpleCondition> extends PraeceptaDateEqualConditionalEvaluator<INPUT> {
	...
	protected ConditionOperatorType getOperatorType() {
		return ConditionOperatorType.GREATER_THAN_EQUAL_DATE;
	}
}
