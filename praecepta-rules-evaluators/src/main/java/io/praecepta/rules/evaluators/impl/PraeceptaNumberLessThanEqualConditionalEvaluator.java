...
public class PraeceptaNumberLessThanEqualConditionalEvaluator<INPUT extends PraeceptaSimpleCondition> extends PraeceptaNumberEqualConditionalEvaluator<INPUT> {
	...
	protected ConditionOperatorType getOperatorType() {
		return ConditionOperatorType.LESS_THAN_EQUAL_NUMBER;
	}
}
