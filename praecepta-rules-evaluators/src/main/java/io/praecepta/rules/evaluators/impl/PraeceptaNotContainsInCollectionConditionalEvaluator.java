...
public class PraeceptaNotContainsInCollectionConditionalEvaluator<INPUT extends PraeceptaSimpleCondition> extends PraeceptaStringEqualConditionalEvaluator<INPUT> {
	...
	protected ConditionOperatorType getOperatorType() {
		return ConditionOperatorType.NOT_CONTAINS_IN_COLLECTION;
	}
}
