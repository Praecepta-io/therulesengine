...
public class PraeceptaNumberGreaterThanConditionalEvaluator<INPUT extends PraeceptaSimpleCondition> extends PraeceptaNumberEqualConditionalEvaluator<INPUT> {
	...
	protected ConditionOperatorType getOperatorType() {
		return ConditionOperatorType.GREATER_THAN_NUMBER;
	}
}
