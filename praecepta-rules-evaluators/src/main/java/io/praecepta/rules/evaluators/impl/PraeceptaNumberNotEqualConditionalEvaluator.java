...
public class PraeceptaNumberNotEqualConditionalEvaluator<INPUT extends PraeceptaSimpleCondition> extends PraeceptaNumberEqualConditionalEvaluator<INPUT> {
	...
	protected ConditionOperatorType getOperatorType() {
		return ConditionOperatorType.NOT_EQUAL_NUMBER;
	}
}
