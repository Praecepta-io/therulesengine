...
public class MultiNestedConditionNestedAttibuteRuleExecutionTest {
    ...
    public void test(){
        ...
        pathParams.put(PATH_PARAM_GROUP_NAME, "multinestedvalidation");
    ...
    public void test3(){
        ...
        store.upsertToPraeceptaStore(PraeceptaWsRequestStoreType.WS_INPUT, getInputMessage3());
    ...
    public String getInputMessage2(){
        ...
        return "{\"emp\":{\"name\":\"prasad\", \"dob\":\"1999-01-01\"}}";
    }

    public String getInputMessage3
            (){

        return "{\"emp\":{\"name\":\"prasad\", \"dob\":\"1997-01-01\"}}";
    }
}
