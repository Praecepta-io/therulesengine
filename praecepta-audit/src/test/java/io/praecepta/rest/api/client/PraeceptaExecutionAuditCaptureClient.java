...
public class PraeceptaExecutionAuditCaptureClient {
...
//		HttpPost httpPost = new HttpPost("http://localhost:8080/audit/addRuleGroupAudit/ABC/Risk/Creadit/V2/Credit");
		HttpPut httpPost = new HttpPut(
				"http://localhost:4567/audit/addRuleGroupExecutionAudit/ABC/Risk/Creadit/V2/CreditCheck");

		PraeceptaExecutionAuditPoint executionTraceDto = getRuleExecutionAuditPoint();

		String json = GsonHelper.toJson(executionTraceDto);
